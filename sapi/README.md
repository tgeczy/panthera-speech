...
user. Its three separate engines are kept under `%APPDATA%\Panthera SAPI` as
the `Tiger`, `Leopard`, and `Lion` subfolders. It does not read or modify
NVDA's speech-data folder.
